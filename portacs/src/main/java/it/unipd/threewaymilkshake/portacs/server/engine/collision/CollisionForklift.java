...
/**
 * 0- List<CollisionForklift> -> DeadlockCheck
 * 1- List<CollisionForklift> -> CollisioDetection
 * 2- Map<SimplePoint,List<CollisionForklift>> -> NumberOfCollisions
 * 3- Map<SimplePoint,List<CollisionForklift>> -> HeadOnCollision
 * 4- Map<SimplePoint,List<CollisionForklift>> -> NearestToCollision
 * 5- List<CollisionForklift>
 * 
 */