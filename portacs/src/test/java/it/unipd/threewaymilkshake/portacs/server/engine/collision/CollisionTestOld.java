...
public class CollisionTestOld {
    @Mock
    Forklift first = new Forklift("1","sfdatyrsd");
    @Mock
    Forklift second = new Forklift("2","sfdyrtasd");
    @Mock
    Forklift third = new Forklift("3","sfdaytrsd");
    ...
    public void pipelineTest() {
        ...
        ReflectionTestUtils.setField(first, "pathToNextTask", Arrays.asList(Move.GOSTRAIGHT,Move.GOSTRAIGHT));
        ReflectionTestUtils.setField(second, "pathToNextTask", Arrays.asList(Move.GOSTRAIGHT,Move.GOSTRAIGHT));
        ReflectionTestUtils.setField(third, "pathToNextTask", Arrays.asList(Move.GOSTRAIGHT,Move.GOSTRAIGHT));
        ...
        when(first.getNextPositions(2)).thenReturn(Arrays.asList(new SimplePoint(3,3),new SimplePoint(4,3),new SimplePoint(5,3)));
        when(second.getNextPositions(2)).thenReturn(Arrays.asList(new SimplePoint(5,1),new SimplePoint(5,2),new SimplePoint(5,3)));
        when(third.getNextPositions(2)).thenReturn(Arrays.asList(new SimplePoint(4,5),new SimplePoint(4,4),new SimplePoint(4,3)));
