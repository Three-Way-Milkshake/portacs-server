...
public class CollisionMapTest {
    ...
    public void sumTest() {
        ...
        Set<CollisionForklift> expectedSet = (Set<CollisionForklift>) ReflectionTestUtils.getField(expected,"collisionsForCell");
        Set<CollisionForklift> toCompareSet = (Set<CollisionForklift>) ReflectionTestUtils.getField(toCompare,"collisionsForCell");
