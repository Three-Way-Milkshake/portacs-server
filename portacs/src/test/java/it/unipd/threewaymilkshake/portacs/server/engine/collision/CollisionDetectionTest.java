...
public class CollisionDetectionTest {
    ...
    public void processTest() {
        ...
        List<CollisionForklift> collisionForklift = new LinkedList<CollisionForklift>(List.of(first,second,third));
        List<SimplePoint> firstForkliftPoints = new LinkedList<SimplePoint>(List.of(new SimplePoint(1,1),new SimplePoint(1,2),new SimplePoint(1,3)));
        List<SimplePoint> secondForkliftPoints = new LinkedList<SimplePoint>(List.of(new SimplePoint(3,2),new SimplePoint(2,2),new SimplePoint(1,2)));
        List<SimplePoint> thirdForkliftPoints = new LinkedList<SimplePoint>(List.of(new SimplePoint(2,4),new SimplePoint(2,3),new SimplePoint(2,2)));

        when(forklift.getNextPositions(2)).thenReturn(firstForkliftPoints,secondForkliftPoints,thirdForkliftPoints);
        

        Map<SimplePoint, List<CollisionForklift>> collisions = new HashMap<>();
        collisions.put(new SimplePoint(1,2),new LinkedList<CollisionForklift>(List.of(first,second)));
        collisions.put(new SimplePoint(232,2),new LinkedList<CollisionForklift>(List.of(second,third)));
        ...
        collisionsToCompareWith.put(new SimplePoint(1,2),new LinkedList<CollisionForklift>(List.of(second,first)));
        collisionsToCompareWith.put(new SimplePoint(2,2),new LinkedList<CollisionForklift>(List.of(second,third)));
