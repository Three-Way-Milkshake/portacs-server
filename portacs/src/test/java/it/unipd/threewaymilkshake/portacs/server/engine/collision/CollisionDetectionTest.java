...
public class CollisionDetectionTest {
  ...
  public void processTest() { // TODO: più test di integrazione che di unità?
    ...
    input.put(
        "2", Arrays.asList(new SimplePoint(5, 1), new SimplePoint(5, 2), new SimplePoint(5, 3)));
    input.put(
        "3", Arrays.asList(new SimplePoint(4, 5), new SimplePoint(4, 4), new SimplePoint(4, 3)));
    input.put(
        "4", Arrays.asList(new SimplePoint(4, 1), new SimplePoint(4, 2), new SimplePoint(4, 3)));
